...
% --- Authors ---
\author{%
\IEEEauthorblockN{Ioannis Bakagiannis}
\IEEEauthorblockA{\textit{Department of Digital Systems} \\ \textit{University of Thessaly} \\ Larisa, Greece \\ ibakagiannis@uth.gr}\and
\IEEEauthorblockN{Vassilis C. Gerogiannis}
\IEEEauthorblockA{\textit{Department of Digital Systems} \\ \textit{University of Thessaly} \\ Larisa, Greece \\ vgerogian@uth.gr}}
...
\centering
\footnotesize
\begin{tabular}{>{\raggedright\arraybackslash}p{0.105\textwidth}>{\raggedright\arraybackslash}p{0.847\textwidth}}
\toprule
Variable & Value \\
\midrule
...
\centering
\footnotesize
\begin{tabular}{>{\raggedright\arraybackslash}p{0.122\textwidth}>{\raggedright\arraybackslash}p{0.378\textwidth}>{\raggedright\arraybackslash}p{0.218\textwidth}>{\raggedright\arraybackslash}p{0.186\textwidth}}
\toprule
...
\begin{table*}[htbp]
\caption{Content and functionality comparison across approaches. CS R1 is the
creative studio's pre-feedback state.}
\centering
\small
\begin{tabular}{>{\raggedright\arraybackslash}p{0.210\textwidth}>{\centering\arraybackslash}p{0.126\textwidth}>{\centering\arraybackslash}p{0.126\textwidth}>{\centering\arraybackslash}p{0.115\textwidth}>{\centering\arraybackslash}p{0.304\textwidth}}
\toprule
...
Fig.~\ref{fig:desktop} shows the desktop hero sections side by side. The most striking difference is not visual polish -- all approaches produce visually competent output -- but \textbf{content depth}. The skill and workflow approaches produced attractive templates. The creative studio's final output produced a page a patient could actually use.
...
\centering
\small
\begin{tabular}{>{\raggedright\arraybackslash}p{0.440\textwidth}>{\centering\arraybackslash}p{0.096\textwidth}>{\centering\arraybackslash}p{0.110\textwidth}>{\centering\arraybackslash}p{0.096\textwidth}>{\centering\arraybackslash}p{0.138\textwidth}}
\toprule
...
three personas (range in parentheses). R2 scores reflect the pre-form
build.}
\centering
\small
\begin{tabular}{lccc}
...
\centering
\small
\begin{tabular}{>{\raggedright\arraybackslash}p{0.261\textwidth}>{\centering\arraybackslash}p{0.062\textwidth}>{\centering\arraybackslash}p{0.099\textwidth}>{\centering\arraybackslash}p{0.062\textwidth}>{\centering\arraybackslash}p{0.397\textwidth}}
\toprule
...
\centering
\small
\begin{tabular}{>{\raggedright\arraybackslash}p{0.375\columnwidth}>{\centering\arraybackslash}p{0.090\columnwidth}>{\centering\arraybackslash}p{0.120\columnwidth}>{\centering\arraybackslash}p{0.225\columnwidth}}
\toprule
